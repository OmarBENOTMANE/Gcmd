...
INSERT INTO gcmd_ligne_bp (id, date, heure, nombre, prestation, produit, sens_trafic, tarif_unifie, tc_conv, tc_suppl,
                           tonnage_minimum, tonnage_reel, bulltin_prestation_id)
VALUES (1, '2022-05-01', '13:00:00', 2, 'prest', 'prod', 'IMPORT', true, false, 'tc supp', 4, 5, 1);
